...
/**
 * An action that adds the workflow object to DataflowSelectionModel.
 * This has an effect of previously selected workflow component in the Graph View to
 * become deselected and workflow metadata showing in the contextual view.
 * 
 * @author Alex Nenadic
 *
 */
@SuppressWarnings("serial")
public class WorkflowMetadataAction extends AbstractAction{
	...
	public WorkflowMetadataAction(){
		super();
		putValue(SMALL_ICON, WorkbenchIcons.workflowExplorerIcon);
		putValue(NAME, "Workflow Metadata");	
		putValue(SHORT_DESCRIPTION, "Workflow metadata");	
	...
	public void actionPerformed(ActionEvent e) {
		...
		selectionModel.addSelection(dataflow);
	}
