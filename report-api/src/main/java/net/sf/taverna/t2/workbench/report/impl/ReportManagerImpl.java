...
//	private Set<Visitor<?>> visitors;
	...
	protected ReportManagerImpl(EditManager editManager, FileManager fileManager, Set<Visitor<?>> visitors) throws IllegalStateException {
...
//			this.visitors = visitors;
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#updateReport(net.sf.taverna.t2.workflowmodel.Dataflow, boolean, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#updateObjectSetReport(net.sf.taverna.t2.workflowmodel.Dataflow, java.util.Set)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#updateObjectReport(net.sf.taverna.t2.workflowmodel.Dataflow, java.lang.Object)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getReports(net.sf.taverna.t2.workflowmodel.Dataflow, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getReports(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#isStructurallySound(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getStatus(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getStatus(net.sf.taverna.t2.workflowmodel.Dataflow, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getSummaryMessage(net.sf.taverna.t2.workflowmodel.Dataflow, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getLastCheckedTime(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#getLastFullCheckedTime(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#addObserver(net.sf.taverna.t2.lang.observer.Observer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#removeObserver(net.sf.taverna.t2.lang.observer.Observer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.report.ReportManagerI#isReportOutdated(net.sf.taverna.t2.workflowmodel.Dataflow)
	 */
	@Override
