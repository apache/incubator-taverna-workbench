...
public class SaveAllResultsSPIRegistry extends SPIRegistry<SaveAllResultsSPI>{
	...
	protected SaveAllResultsSPIRegistry() {
		super(SaveAllResultsSPI.class);
	}

	/**
	 * Get the singleton instance of this registry.
	 */
	public static synchronized SaveAllResultsSPIRegistry getInstance() {
		return Singleton.instance;
	}
	
	private static class Singleton {
		private static final SaveAllResultsSPIRegistry instance = new SaveAllResultsSPIRegistry();
	}
	
	/**
	 * Returns a list containing all instances of the SaveAllResultsSPI.
	 */
	public List<SaveAllResultsSPI> getSaveResultActions() {
		List<SaveAllResultsSPI> result = new ArrayList<SaveAllResultsSPI>();
