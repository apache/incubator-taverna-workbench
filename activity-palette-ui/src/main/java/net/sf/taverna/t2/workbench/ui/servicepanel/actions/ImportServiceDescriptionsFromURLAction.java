...
/**
 * Action to import a list of service descriptions from an URL pointing to an
 * xml file into the Service Registry. Users have an option to completely
 * replace the current services or just add the ones from the file to the
 * current services.
 * 
 * @author Alex Nenadic
 * 
...
public class ImportServiceDescriptionsFromURLAction extends AbstractAction {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (choice != JOptionPane.CANCEL_OPTION) {
			...
			final String urlString = (String) JOptionPane.showInputDialog(
					parentComponent,
					"Enter the URL of the service descriptions file to import",
					"Service Descriptions URL", JOptionPane.QUESTION_MESSAGE,
					null, null, "http://");
			if (urlString != null) {
	...
	private void replaceServices(final String urlString) throws Exception {
	...
	private void addServices(final String urlString) throws Exception {
