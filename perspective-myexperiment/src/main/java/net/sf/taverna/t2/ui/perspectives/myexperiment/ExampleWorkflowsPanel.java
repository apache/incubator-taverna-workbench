...
public class ExampleWorkflowsPanel extends JPanel implements ActionListener,
  ...
  public ExampleWorkflowsPanel(MainComponent component,
...
//		.setText(this.workflows.size() + " example workflows found");
  ...
  private void initialiseUI() {
	...
	this.refreshButton
		.setToolTipText("Click this button to refresh the Example Workflows list");
	topPanel.add(this.refreshButton, BorderLayout.EAST);
	this.add(topPanel, BorderLayout.NORTH);

	this.workflowsListPanel = new ResourceListPanel(this.pluginMainComponent,
		this.myExperimentClient, this.logger);
	JScrollPane spExampleWorkflowList = new JScrollPane(this.workflowsListPanel);
	spExampleWorkflowList.getVerticalScrollBar().setUnitIncrement(
