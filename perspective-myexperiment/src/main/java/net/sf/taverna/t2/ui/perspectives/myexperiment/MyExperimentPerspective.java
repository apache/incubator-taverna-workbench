  ...
  private boolean visible = true;
	...
	public static URL getLocalResourceURL(String strResourceName)
	{
      ...
      strResourcePath += "comment_add.png";
	    ...
	    throw new java.lang.IllegalArgumentException("Unknown myExperiment plugin resource requested; requested resource name was: " + strResourceName);
	  }
  ...
  //a single point in the plugin where all resources' icons are referenced
	public static URL getLocalIconURL(int iResourceType)
	{
	  ...
	  switch (iResourceType) {
        ...
        break;
      default:
        throw new java.lang.IllegalArgumentException("Unknown myExperiment plugin resource requested; requested resource name was: " + Resource.getResourceTypeName(iResourceType));
	  }
