...
public class MonitorViewComponent extends JPanel{

	private MonitorGraphComponent monitorGraph;
	private WorkflowRunProgressTreeTable monitorProgressTable;
...
//		buttonsPanel.add(new JButton("Show results"));
	...
	public MonitorGraphComponent getMonitorGraph() {
		return monitorGraph;
	}

	public void setMonitorProgressTable(WorkflowRunProgressTreeTable monitorProgressTable) {
		this.monitorProgressTable = monitorProgressTable;
		
		JScrollPane scrollPane = new JScrollPane(monitorProgressTable,
	...
	public WorkflowRunProgressTreeTable getMonitorProgressTable() {
