...
public class SVGMouseOverEventListener extends SVGEventListener {
	...
	public SVGMouseOverEventListener(GraphEventManager graphEventManager, GraphElement graphElement) {
	...
	public void handleEvent(Event evt) {
		if (evt instanceof MouseEvent) {
			...
			graphEventManager.mouseOver(graphElement, mouseEvent.getButton(),
