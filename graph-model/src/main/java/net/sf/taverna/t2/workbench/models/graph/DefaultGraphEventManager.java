...
public class DefaultGraphEventManager implements GraphEventManager {
	 ...
	 * (non-Javadoc)
	 * @see
	 * net.sf.taverna.t2.workbench.models.graph.EventGraphManager#mouseClicked(net.sf.taverna.t2
	 * .workbench.models.graph.GraphElement, short, boolean, boolean, boolean, int, int, int, int)
	 */
	public void mouseClicked(final GraphElement graphElement, short button, boolean altKey,
		...
		if ((button == 2) || ctrlKey) {
			if (dataflowObject == null) {
				...
				menu = menuManager.createContextMenu(graphController.getWorkflow(), dataflowObject,
						component);
				if (dataflowObject instanceof Processor) {
					final Processor processor = (Processor) dataflowObject;
					ProcessorBinding processorBinding = scufl2Tools.processorBindingForProcessor(
							processor, graphController.getProfile());
	 ...
	 * (non-Javadoc)
	 * @see
	 * net.sf.taverna.t2.workbench.models.graph.EventGraphManager#mouseDown(net.sf.taverna.t2.workbench
	 * .models.graph.GraphElement, short, boolean, boolean, boolean, int, int, int, int)
	 */
	public void mouseDown(GraphElement graphElement, short button, boolean altKey, boolean ctrlKey,
			boolean metaKey, int x, int y, int screenX, int screenY) {
		if (button == 0) {
	 ...
	 * (non-Javadoc)
	 * @see
	 * net.sf.taverna.t2.workbench.models.graph.EventGraphManager#mouseUp(net.sf.taverna.t2.workbench
	 * .models.graph.GraphElement, short, boolean, boolean, boolean, int, int, int, int)
	 */
	public void mouseUp(GraphElement graphElement, short button, boolean altKey, boolean ctrlKey,
			boolean metaKey, final int x, final int y, int screenX, int screenY) {
		if (button == 0) {
	 ...
	 * (non-Javadoc)
	 * @see
	 * net.sf.taverna.t2.workbench.models.graph.EventGraphManager#mouseMoved(net.sf.taverna.t2.workbench
	 * .models.graph.GraphElement, short, boolean, boolean, boolean, int, int, int, int)
	 */
	...
	public void mouseOver(GraphElement graphElement, short button, boolean altKey, boolean ctrlKey,
			boolean metaKey, int x, int y, int screenX, int screenY) {
	...
	public void mouseOut(GraphElement graphElement, short button, boolean altKey, boolean ctrlKey,
			boolean metaKey, int x, int y, int screenX, int screenY) {
		if (graphElement.getWorkflowBean() != null) {
