...
import net.sf.taverna.t2.activities.dataflow.menu.AddDataflowActivityTemplateAction;
...
public class AddNestedWorkflowMenuAction extends AbstractMenuAction {
	...
	private static Logger logger = Logger
			.getLogger(AddDataflowActivityTemplateAction.class);
	...
	protected Action createAction() {
		AddNestedWorkflowAction a = new AddNestedWorkflowAction();
