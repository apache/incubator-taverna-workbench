...
import net.sf.taverna.t2.workbench.views.results.workflow.WorkflowResultTreeNode;
...
public class PortTab extends JPanel {
	...
	public class RowListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent event) {
			...
			WorkflowResultTreeNode node = new WorkflowResultTreeNode((T2Reference) object,
					getContext());
			try {
