...
public class DataflowOutputPortContextualViewFactory implements
	...
	public List<ContextualView> getViews(DataflowOutputPortImpl outputport) {
		return Arrays.asList(new ContextualView[] {new DataflowOutputPortContextualView(outputport)});
	}
