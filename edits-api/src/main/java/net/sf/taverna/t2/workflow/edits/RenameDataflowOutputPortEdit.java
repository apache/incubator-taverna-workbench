...
public class RenameDataflowOutputPortEdit extends AbstractDataflowOutputPortEdit {
	...
	public RenameDataflowOutputPortEdit(OutputWorkflowPort dataflowOutputPort, String newName) {
		super(dataflowOutputPort);
		this.newName = newName;
	}

	@Override
	protected void doEditAction(OutputWorkflowPort dataflowOutputPort) {
		oldName = dataflowOutputPort.getName();
		dataflowOutputPort.setName(newName);
	}

	@Override
	protected void undoEditAction(OutputWorkflowPort dataflowOutputPort) {
