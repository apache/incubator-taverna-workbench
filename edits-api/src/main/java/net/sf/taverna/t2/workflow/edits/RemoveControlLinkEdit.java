...
/**
 * Remove a ControlLink from a Workflow.
 *
 * @author David Withers
 *
 */
public class RemoveControlLinkEdit extends AbstractDataflowEdit {

	private ControlLink controlLink;

	public RemoveControlLinkEdit(Workflow workflow, ControlLink controlLink) {
		super(workflow);
