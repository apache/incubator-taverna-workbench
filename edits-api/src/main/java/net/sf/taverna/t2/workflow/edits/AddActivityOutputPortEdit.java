...
public class AddActivityOutputPortEdit extends AbstractActivityEdit {
	...
	private OutputActivityPort activityOutputPort;

	public AddActivityOutputPortEdit(Activity activity, OutputActivityPort activityInputPort) {
		super(activity);
	...
	protected void doEditAction(Activity activity) {
		activityOutputPort.setParent(activity);
	}

	@Override
	protected void undoEditAction(Activity activity) {
		activityOutputPort.setParent(null);
	}
