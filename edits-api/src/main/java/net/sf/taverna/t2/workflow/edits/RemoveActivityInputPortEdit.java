...
public class RemoveActivityInputPortEdit extends AbstractActivityEdit {
	...
	private InputActivityPort inputActivityPort;

	public RemoveActivityInputPortEdit(Activity activity, InputActivityPort inputActivityPort) {
		super(activity);
	...
	protected void doEditAction(Activity activity) {
		inputActivityPort.setParent(null);
	}
